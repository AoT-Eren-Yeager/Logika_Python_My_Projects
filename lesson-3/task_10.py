# Напиши програму, яка переводить градуси за Фаренгейтом в градуси за Цельсієм. Відповідь програма повинна друкувати в один рядок в такому форматі: "градусів Цельсія: <відповідь>"
...
# (Пункт 4). Тепер рядок "градусів Цельсія:" потрібно об'єднати з кінцевою відповіддю, але відповідь спочатку переводиться з числа в рядок!
